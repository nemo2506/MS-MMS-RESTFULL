...
class MsMmsApp : Application() {
    ...
    override fun onCreate() {
        ...
        try {
            ...
            com.miseservice.msmms.util.NetworkInfoProvider.setApiPort(initialPort)
            // Initialisation réseau best-effort: ne jamais bloquer le démarrage de l'app.
            try {
                com.miseservice.msmms.util.NetworkInfoProvider.init(this)
            } catch (_: Exception) {
            }
            ...
            appScope.launch {
                settingsRepository.observeSettings().collect { observed ->
                    ...
                    com.miseservice.msmms.util.NetworkInfoProvider.setApiPort(port)
